...
import static seedu.watson.logic.parser.CliSyntax.PREFIX_GRADE;
...
public class CommandTestUtil {
     ...
     * - the watson book, filtered person list and selected person in {@code actualModel} remain unchanged
     */
